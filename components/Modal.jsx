            ...
            <div className="col-lg-5 p-4 p-lg-5 d-flex flex-column">
              <div className="mb-4">
                <div className="d-flex align-items-center gap-3 mb-3">
                  <span className="badge bg-soft-purple text-info border border-info font-monospace">
                    {project.category}
                  </span>
                  <span className="text-secondary font-monospace d-flex align-items-center gap-1">
              ...
              <div className="mt-auto">
                ...
                <div className="d-flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="badge bg-secondary text-dark fw-normal p-2 font-monospace"
                    >
                      {tag}
                    </span>
                  ))}
